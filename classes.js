...
class ProgressiveManager {
  ...
  hire (employee){
     this.reports.push(employee);
     if(this.reports.length >= 101){return this.title = "Bestest Manager"}
     else if (this.reports.length >= 51){return this.title = "Manager Plus"}
     else if (this.reports.length >=11){return this.title = "Manager"}
     else if (this.reports.length >= 4){return this.title = "Mostly Manager"}
     else if (this.reports.length >= 1){return this.title = "Barely Manager"}
